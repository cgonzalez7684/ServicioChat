    ...
    public partial class frmConsulta : Form
    {
        ...
        private void frmConsulta_Load(object sender, EventArgs e)
        {
            using (chatEntidad context = new chatEntidad())
            {
                ...
                totRes.Add(new { nCategoriaChat = 0, cNombreCate = "TODOS" });
                var totRes2 = totRes.OrderBy(x => x.nCategoriaChat).ToList();
                cmbCategorias.DataSource = totRes2;
                cmbCategorias.DisplayMember = "cNombreCate";
                cmbCategorias.ValueMember = "nCategoriaChat";
            }
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            try { 
                ...
                categoria = Int32.Parse((cmbCategorias.SelectedValue.ToString()));
                ...
                using (chatEntidad context = new chatEntidad())
                {
                    if (idEmpleado == 0)
                    {
                        chatsF = (from item in context.chats 
                                  where
                                    (item.dFechaIng >= fechaIni && item.dFechaIng <= fechaFin) && (chkPalabra.Checked == true ? item.cTextoChat.Contains(palabra) : 0 == 0)
                                    && (calificacion != 0 ? item.nCalifica == calificacion : 0 == 0) && (categoria != 0 ? item.nCategoriaChat == categoria: 0==0)
                                 select item.dFechaFin).Count();
                        chatsB = (from item in context.chats
                                  where (item.dFechaIng >= fechaIni && item.dFechaIng <= fechaFin) && (chkPalabra.Checked == true ? item.cTextoChat.Contains(palabra) : 0 == 0)
                                  && (calificacion != 0 ? item.nCalifica == calificacion : 0 == 0) && (categoria != 0 ? item.nCategoriaChat == categoria : 0 == 0)
                                      && item.nCalifica > 2  
                                  select item.dFechaFin).Count();
                    ...
                    else
                    {
                        chatsF = (from item in context.chats
                                  ...
                                  where
                                    ...
                                    && item2.nIdUsuario.ToString() == idEmpleado.ToString() && (chkPalabra.Checked == true ? item.cTextoChat.Contains(palabra) : 0 == 0)
                                    && (calificacion != 0 ? item.nCalifica == calificacion : 0 == 0) && (categoria != 0 ? item.nCategoriaChat == categoria : 0 == 0)
                                  select item.dFechaFin).Count();
                        chatsB = (from item in context.chats
                                  join item2 in context.usuarios
                                  ...
                                  where (item.dFechaIng >= fechaIni && item.dFechaIng <= fechaFin)
                                   && item2.nIdUsuario.ToString() == idEmpleado.ToString() && item.nCalifica > 2 && (chkPalabra.Checked == true ? item.cTextoChat.Contains(palabra) : 0 == 0)
                                   && (calificacion != 0 ? item.nCalifica == calificacion : 0 == 0) && (categoria != 0 ? item.nCategoriaChat == categoria : 0 == 0)
                                  select item.dFechaFin).Count();
                        chatsM = (from item in context.chats
                                  join item2 in context.usuarios
                                        on item.cCodigoUsu equals item2.cCodigousu
                                  where (item.dFechaIng >= fechaIni && item.dFechaIng <= fechaFin)
                                   && item2.nIdUsuario.ToString() == idEmpleado.ToString() && item.nCalifica < 3 && (chkPalabra.Checked == true ? item.cTextoChat.Contains(palabra) : 0 == 0)
                                   && (calificacion != 0 ? item.nCalifica == calificacion : 0 == 0) && (categoria != 0 ? item.nCategoriaChat == categoria : 0 == 0)
                                  select item.dFechaFin).Count();
                    }
        ...
        private void lblTotChat_Click(object sender, EventArgs e)
        {
            ...
            detalle detchat = new detalle(7, "Total Chats", fechaIni, fechaFin, idEmpleado, uPalabra, palabra, calificacion,categoria);
            detchat.Show();
        }
        ...
        private void lblBueno_Click(object sender, EventArgs e)
        {
            ...
            detalle detchat = new detalle(8, "Chats Buenos", fechaIni, fechaFin, idEmpleado, uPalabra, palabra, calificacion, categoria);
            detchat.Show();
        }
        ...
        private void lblMalo_Click(object sender, EventArgs e)
        {
            ...
            detalle detchat = new detalle(9, "Total Malos", fechaIni, fechaFin, idEmpleado, uPalabra, palabra, calificacion, categoria);
            detchat.Show();
        }
