    ...
    public partial class FrmMain : Form
    {
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            foreach (Form form in Application.OpenForms)
            {
                ...
                {
                    MessageBox.Show("No puede abrir otra ventana si tiene la ventana de chat abierta", "Chat", MessageBoxButtons.OK, MessageBoxIcon.None,
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            viewChat.Show();
            viewChat.WindowState = FormWindowState.Normal;
        }
        ...
        private void FrmMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            //    if (form.GetType() == typeof(frmChat))
            //    {
            //        MessageBox.Show("No puede cerrar la aplicación ya que la ventana del chat se encuentra activa, finalice el chat que tenga activo y proceda a cerrar la ventan del chat.", "Chat", MessageBoxButtons.OK, MessageBoxIcon.None,
            //        MessageBoxDefaultButton.Button1, (MessageBoxOptions)0x40000);
        ...
        private void toolStripSeparator6_Click(object sender, EventArgs e)
        {
            ...
            frmManual manualUsuario = new frmManual();
            manualUsuario.MdiParent = this;
            manualUsuario.Show();
            manualUsuario.WindowState = FormWindowState.Maximized;
        }
    }
}
