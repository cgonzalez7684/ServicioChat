...
namespace App
{
    public partial class detalle : Form
    {
        ...
        public detalle(int tipo, string detalle, DateTime fechai, DateTime fechaf, int id, int tipoP, string ppalabra, int califica, int cate)
        {
                ...
                using (chatEntidad context = new chatEntidad())
                {
                    ...
                    if (tipoF == 1 || tipoF == 4)
                    {
                        ...
                        ChatBase = (from item in context.chats
                                    ...
                                    where DbFunctions.DiffDays(DateTime.Now, item.dFechaFin) == 0 && (tipoPalabra == 1 ? item.cTextoChat.Contains(palabra) : 0 == 0)
                    ...
                    if (tipoF == 5)
                    {
                        ...
                        ChatBase = (from item in context.chats
                                    join item2 in context.usuarios
                                    on item.cCodigoUsu equals item2.cCodigousu
                                    where DbFunctions.DiffDays(DateTime.Now, item.dFechaFin) == 0 && item.nCalifica > 2 && (tipoPalabra == 1 ? item.cTextoChat.Contains(palabra) : 0 == 0)
                                    && (calificacion != 0 ? item.nCalifica == calificacion : 0 == 0) && (categoria != 0 ? item.nCategoriaChat == categoria : 0 == 0)
                                    select new chat
                                    {
                                        NombreCliente = item.cNomclient,
                    ...
                    if (tipoF == 6)
                    {
                        ...
                        ChatBase = (from item in context.chats
                                    join item2 in context.usuarios
                                    on item.cCodigoUsu equals item2.cCodigousu
                                    where DbFunctions.DiffDays(DateTime.Now, item.dFechaFin) == 0 && item.nCalifica < 3 && (tipoPalabra == 1 ? item.cTextoChat.Contains(palabra) : 0 == 0)
                                    && (calificacion != 0 ? item.nCalifica == calificacion : 0 == 0) && (categoria != 0 ? item.nCategoriaChat == categoria : 0 == 0)
                                    select new chat
                                    {
                                        NombreCliente = item.cNomclient,
                    ...
                    if (tipoF == 7)
                    {
                        ...
                        ChatBase = (from item in context.chats
                                    ...
                                    on item.cCodigoUsu equals item2.cCodigousu
                                    where
                                      (item.dFechaIng >= fechaIni && item.dFechaIng <= fechaFin) && (tipoPalabra == 1 ? item.cTextoChat.Contains(palabra) : 0 == 0)
                                      && (calificacion != 0 ? item.nCalifica == calificacion : 0 == 0) && (categoria != 0 ? item.nCategoriaChat == categoria : 0 == 0)
                                    select new chat
                                    {
                                        NombreCliente = item.cNomclient,
                        ...
                        else
                        {
                            ChatBase = (from item in context.chats
                                        join item2 in context.usuarios
                                        on item.cCodigoUsu equals item2.cCodigousu
                                        where (item.dFechaIng >= fechaIni && item.dFechaIng <= fechaFin) && (tipoPalabra == 1 ? item.cTextoChat.Contains(palabra) : 0 == 0)
                                        && (calificacion != 0 ? item.nCalifica == calificacion : 0 == 0) && (categoria != 0 ? item.nCategoriaChat == categoria : 0 == 0)
                    ...
                    if (tipoF == 8)
                    {
                        ...
                        else
                        {
                            ChatBase = (from item in context.chats
                                        ...
                                        && item2.nIdUsuario.ToString() == idEmpleado.ToString() && item.nCalifica > 2 && (tipoPalabra == 1 ? item.cTextoChat.Contains(palabra) : 0 == 0)
                                        && (calificacion != 0 ? item.nCalifica == calificacion : 0 == 0) && (categoria != 0 ? item.nCategoriaChat == categoria : 0 == 0)
                                        select new chat
                                        {
                                            NombreCliente = item.cNomclient,
                    ...
                    if (tipoF == 9)
                    {
                        ...
                        else
                        {
                            ChatBase = (from item in context.chats
                                        ...
                                        on item.cCodigoUsu equals item2.cCodigousu
                                        where (item.dFechaIng >= fechaIni && item.dFechaIng <= fechaFin)
                                        && item2.nIdUsuario.ToString() == idEmpleado.ToString() && item.nCalifica < 3 && (tipoPalabra == 1 ? item.cTextoChat.Contains(palabra) : 0 == 0)
                                        && (calificacion != 0 ? item.nCalifica == calificacion : 0 == 0) && (categoria != 0 ? item.nCategoriaChat == categoria : 0 == 0)
                                        select new chat
                                        {
                                            NombreCliente = item.cNomclient,
