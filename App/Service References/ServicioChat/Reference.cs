...
namespace App.ServicioChat {
    ...
    public interface IWebChat {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWebChat/LimpiarChats", ReplyAction="http://tempuri.org/IWebChat/LimpiarChatsResponse")]
        string LimpiarChats(string pass);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWebChat/LimpiarChats", ReplyAction="http://tempuri.org/IWebChat/LimpiarChatsResponse")]
        System.Threading.Tasks.Task<string> LimpiarChatsAsync(string pass);
    }
    ...
    public partial class WebChatClient : System.ServiceModel.ClientBase<App.ServicioChat.IWebChat>, App.ServicioChat.IWebChat {
        ...
        public string LimpiarChats(string pass) {
            return base.Channel.LimpiarChats(pass);
        }
        
        public System.Threading.Tasks.Task<string> LimpiarChatsAsync(string pass) {
            return base.Channel.LimpiarChatsAsync(pass);
        }
    }
}
