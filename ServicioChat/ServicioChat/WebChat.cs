...
namespace ServicioChat
{
    ...
    public class WebChat : IWebChat
    {
        ...
        public int CrearChat(string pNombre, string pTelefono, string pEmail, string pIp, string pass)
        {
            try{
        ...
        public int CrearChat2(string pNombre, string pTelefono, string pEmail, string pIp, string pass)
        {
            try
            {
