...
namespace PruebaServicio.ServicioChat {
    ...
    public partial class Chat : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private PruebaServicio.ServicioChat.Mensaje[] ListaMensajesField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private int estadoField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private PruebaServicio.ServicioChat.Cliente pObjClienteField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private PruebaServicio.ServicioChat.Empleado pObjEmpleadoField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public PruebaServicio.ServicioChat.Mensaje[] ListaMensajes {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public PruebaServicio.ServicioChat.Cliente pObjCliente {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public PruebaServicio.ServicioChat.Empleado pObjEmpleado {
            get {
    ...
    public interface IWebChat {
        ...
        PruebaServicio.ServicioChat.ListaMensaje[] RecibirMensajes(int pIdChat, string pTipo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWebChat/RecibirMensajes", ReplyAction="http://tempuri.org/IWebChat/RecibirMensajesResponse")]
        System.Threading.Tasks.Task<PruebaServicio.ServicioChat.ListaMensaje[]> RecibirMensajesAsync(int pIdChat, string pTipo);
        ...
        PruebaServicio.ServicioChat.Chat ObtenerChat(int pIdChat);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWebChat/ObtenerChat", ReplyAction="http://tempuri.org/IWebChat/ObtenerChatResponse")]
        System.Threading.Tasks.Task<PruebaServicio.ServicioChat.Chat> ObtenerChatAsync(int pIdChat);
        ...
        PruebaServicio.ServicioChat.ListaCliente[] ObtenerListaClientes();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWebChat/ObtenerListaClientes", ReplyAction="http://tempuri.org/IWebChat/ObtenerListaClientesResponse")]
        System.Threading.Tasks.Task<PruebaServicio.ServicioChat.ListaCliente[]> ObtenerListaClientesAsync();
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWebChatChannel : PruebaServicio.ServicioChat.IWebChat, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WebChatClient : System.ServiceModel.ClientBase<PruebaServicio.ServicioChat.IWebChat>, PruebaServicio.ServicioChat.IWebChat {
        ...
        public PruebaServicio.ServicioChat.ListaMensaje[] RecibirMensajes(int pIdChat, string pTipo) {
            return base.Channel.RecibirMensajes(pIdChat, pTipo);
        }
        
        public System.Threading.Tasks.Task<PruebaServicio.ServicioChat.ListaMensaje[]> RecibirMensajesAsync(int pIdChat, string pTipo) {
            return base.Channel.RecibirMensajesAsync(pIdChat, pTipo);
        }
        
        public PruebaServicio.ServicioChat.Chat ObtenerChat(int pIdChat) {
            return base.Channel.ObtenerChat(pIdChat);
        }
        
        public System.Threading.Tasks.Task<PruebaServicio.ServicioChat.Chat> ObtenerChatAsync(int pIdChat) {
        ...
        public PruebaServicio.ServicioChat.ListaCliente[] ObtenerListaClientes() {
            return base.Channel.ObtenerListaClientes();
        }
        
        public System.Threading.Tasks.Task<PruebaServicio.ServicioChat.ListaCliente[]> ObtenerListaClientesAsync() {
